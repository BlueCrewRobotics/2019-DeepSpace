...
void SubCargoGrab::ClampSet(bool state) { clampSolenoid->Set(state); }
...
bool SubCargoGrab::GetTiltPos() { return m_bTiltPos; }
...
bool SubCargoGrab::GetExtend5() { return m_bExtend5Pos; }
...
bool SubCargoGrab::GetExtend7() { return m_bExtend7Pos; }