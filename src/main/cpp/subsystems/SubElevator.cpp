...
void SubElevator::Configure() {
  ...
  elevatorDrive->ConfigReverseLimitSwitchSource(
      LimitSwitchSource_FeedbackConnector, LimitSwitchNormal_NormallyOpen, 0);
  elevatorDrive->ConfigForwardLimitSwitchSource(
      LimitSwitchSource_FeedbackConnector, LimitSwitchNormal_NormallyOpen, 0);
  ...
  // This shouldn't be here.  But it is here for now, setting the level
  // positions and index
  // SubElevator::SetLevelPositionTarget(ELEVATOR_HOME,
  // ELEVATOR_LEVEL_POS_HOME);
  // SubElevator::SetLevelPositionTarget(ELEVATOR_BTM_HATCH,
  // ELEVATOR_LEVEL_BTM_POS_HATCH);
  // SubElevator::SetLevelPositionTarget(ELEVATOR_BTM_BALL,
  // ELEVATOR_LEVEL_BTM_POS_BALL);
  // SubElevator::SetLevelPositionTarget(ELEVATOR_MID_HATCH,
  // ELEVATOR_LEVEL_MID_POS_HATCH);
  // SubElevator::SetLevelPositionTarget(ELEVATOR_MID_BALL,
  // ELEVATOR_LEVEL_MID_POS_BALL);
  // SubElevator::SetLevelPositionTarget(ELEVATOR_TOP_HATCH,
  // ELEVATOR_LEVEL_TOP_POS_HATCH);
  // SubElevator::SetLevelPositionTarget(ELEVATOR_TOP_BALL,
  // ELEVATOR_LEVEL_TOP_POS_BALL);

  SubElevator::SetBallPositionTarget(ELEV_BALL_GRAB, ELEV_BALL_GRAB_POS);
  SubElevator::SetBallPositionTarget(ELEV_BALL_ROCKET_BTM,
                                     ELEV_BALL_ROCKET_BTM_POS);
  SubElevator::SetBallPositionTarget(ELEV_BALL_CONTAINER,
                                     ELEV_BALL_CONTAINER_POS);
  SubElevator::SetBallPositionTarget(ELEV_BALL_ROCKET_MID,
                                     ELEV_BALL_ROCKET_MID_POS);
  SubElevator::SetBallPositionTarget(ELEV_BALL_ROCKET_TOP,
                                     ELEV_BALL_ROCKET_TOP_POS);

  SubElevator::SetHatchPositionTarget(ELEV_HATCH_ROCKET_BTM,
                                      ELEV_HATCH_ROCKET_BTM_POS);
  SubElevator::SetHatchPositionTarget(ELEV_HATCH_ROCKET_MID,
                                      ELEV_HATCH_ROCKET_MID_POS);
  SubElevator::SetHatchPositionTarget(ELEV_HATCH_ROCKET_TOP,
                                      ELEV_HATCH_ROCKET_TOP_POS);
}
...
// Get level of elevator
int SubElevator::GetBallLevel() { return m_iBallLevel; }

// Get level of elevator
int SubElevator::GetHatchLevel() { return m_iHatchLevel; }
...
// Get PID error
int SubElevator::GetPIDerror() { return elevatorDrive->GetClosedLoopError(); }
